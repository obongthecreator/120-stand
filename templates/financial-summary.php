...
<div class="glass-card">
    ...
    <p style="color: var(--text-muted); margin-bottom: 20px; font-size: 0.9rem;">
        ...
        Cash Left = (Cash Sales + Old Cash + Extras + Market Card Cash Left) - Cash Expenses. 
        Only Extras, Cash Expenses, and Market Card Cash Left fields are editable. Values auto-save.
    </p>
    ...
    <p style="color: var(--text-muted); margin-top: 16px; font-size: 0.85rem; text-align: center;">
        <iconify-icon icon="solar:info-circle-linear"></iconify-icon> 
        Formula: Cash Left = (Cash Sales + Old Cash + Extras + Market Card Cash Left) - Cash Expenses
    </p>
</div>
